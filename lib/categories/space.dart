...
class SpaceExploration extends StatefulWidget {
  const SpaceExploration({Key? key}) : super(key: key);

  @override
  _SpaceExplorationState createState() => _SpaceExplorationState();
}

class _SpaceExplorationState extends State<SpaceExploration> {
      ...
      child: Row(
        ...
        children: [
          StreamBuilder<QuerySnapshot>(
              stream: _firestore.collection('space').snapshots(),
